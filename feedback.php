<?php 
	...
	$qry = "SELECT * FROM comments_tbl WHERE status='Active' or status='Deactive' ";
	$rs = mysqli_query($conn,$qry);

	$qry1 = "SELECT * FROM userposts_tbl WHERE status='Active'  ";
...
<head>
	...
	<title>Feedback | Tech Notify</title>
		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<h3 class="page-title"><i class="fas fa-comment-dots"></i> Feedback</h3>
					<section class="main-section">
						<h5 style="margin-bottom: 30px;">Feedback Management</h5>
						<h6 style="font-size: 17px; margin-bottom: 30px;">Comments</h6>
						<form method="get" action="feedback-search" class="form-inline" style="margin-bottom: 10px;">
							...
							<table class="table table-striped table-dark">
								...
								<tbody>
									<tr>
										...
										<td>
											<a href="feedback-status?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-success mb-1"><i class="fas fa-power-off"></i></a>
											<a href="feedback-com-delete?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger mb-1"><i class="fas fa-trash"></i></a>
										</td>
									</tr>								
								</tbody>
								<?php
						...
						<h6 style="font-size: 17px; margin-bottom: 30px; margin-top: 30px;">User's Post</h6>
						<div class="table-responsive">
							<table class="table table-striped table-dark">
								<thead>
									<tr>
								...
								<tbody>
									<tr>
										...
										<td><?php echo $row['doi'] ?></td>
										<td>
											<a href="feedback-post-view?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-primary mb-1"><i class="fas fa-eye"></i></a>
											<a href="feedback-post-delete?id=<?php echo $row['id'] ?>" class="btn btn-sm btn-danger mb-1"><i class="fas fa-trash"></i></a>
										</td>
									</tr>									
								</tbody>
								<?php
