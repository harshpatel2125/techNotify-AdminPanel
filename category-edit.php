		...
		<div class="container">
			<div class="row">
				<div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
					<h3 class="page-title"><i class="fas fa-layer-group"></i> Edit Category</h3>
					<section class="main-section">
						<form method="post" >
							<input type="hidden" name="id" value="<?php echo $row['id'] ?>">
							<div class="form-group">
								<label class="form-label">Category Name</label>
								<input type="text" value="<?php echo $row['name'] ?>" name="category-name" placeholder="Enter the Name of Category" class="form-control theme-txtbox" required>
							</div>
							<div class="form-group">
								<label class="form-label">Category Details</label>
								<textarea name="category-details" placeholder="Enter the Details of Category" class="form-control theme-txtbox mb-3" required><?php echo $row['details'] ?></textarea>
							</div>
							<div class="row">
								<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									<div class="form-group">
										<label class="form-label">Category Creator</label>
										<input type="text" name="category-creator" value="<?php echo $row['creator'] ?>" placeholder="Enter the Name of Creator" class="form-control theme-txtbox" required>
									</div>
								</div>
								<div class="col-12 col-sm-12 col-md-6 col-lg-6 col-xl-6">
									<div class="form-group">
							...
							<?php 
								...
								if (isset($_POST['submit'])) 
								{
									...
									if ($rs) 
									{
										echo '<script>window.location.href = "category-edit"</script>';
									}
									else
									{
